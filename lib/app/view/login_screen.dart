...
// TODO: Reemplaza esta IP por la misma que pusiste en el archivo .env
const String backendHost = "172.17.13.250";
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  final GoogleSignIn _googleSignIn = GoogleSignIn(
    ...
    // Este ID NO es el de la aplicación de Android, sino el de la aplicación web de tu backend.
    serverClientId: '1032148217715-4gecuopmv5um1dn64s4usrmmfg2eqhse.apps.googleusercontent.com',
  );
  ...
  Future<void> _loginWithGoogle() async {
    try {
      ...
      final Uri verifyUrl = Uri.parse('http://$backendHost:8080/auth/google/verify-token');
