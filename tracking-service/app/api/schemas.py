...
class TrackingEventBase(BaseModel):
    ...
    content_id: int = Field(..., ge=0, description="Content ID must be positive or 0 for searches")
    event_type: str = Field(
        ...,
        description="E.g., view, like, unlike, share, comment, search",
        pattern=r"^(view|like|unlike|bookmark|unbookmark|share|comment|search_click|search)$",
    )
